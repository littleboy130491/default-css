user only need to change project.css
...
project.css -> like the setting page where user assign the style. give the characteristics for each project.

user typically only need to change project.css:
